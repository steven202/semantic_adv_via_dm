...
class L2PGDAttack(object):
    def __init__(self, model):
        self.model = model
        self.attack = PGDL2(model, eps=1.0, alpha=0.2, steps=10, random_start=True)
...
for epoch in tqdm(range(0, 200)):
    ...
    test(epoch)
"""
rm classifier_logs/adv_l2.txt
CUDA_VISIBLE_DEVICES=0 python train_classifier_identity_pgd_l2.py >>  classifier_logs/adv_l2.txt
"""
